...
export const Button: React.FC<ButtonProps> = ({
  ...
  return (
    <Element
      className={cn(
        'bg-yellow-500 relative z-10 bg-transparent hover:border-secondary hover:bg-yellow-500/50  border border-transparent text-white text-sm md:text-sm transition font-medium duration-200  rounded-md px-4 py-2  flex items-center justify-center ',
        variantClass,
        className
      )}
      {...props}
